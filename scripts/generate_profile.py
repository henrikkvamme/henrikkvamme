...
def build_svg(stats: dict[str, int], portrait: list[str]) -> str:
    ...
    details = "\n".join(
        (
            ...
            row(250, "Focus", "Agent systems, developer tools, AI/ML"),
            section(294, "Stack"),
            row(326, "Languages", "TypeScript, Rust, Go, Python"),
            row(352, "Frontend", "React, Next.js, Tailwind CSS"),
            row(378, "Backend", "Node.js, PostgreSQL, gRPC"),
            row(404, "Infra", "Nix, Docker, self-hosting"),
            section(448, "Building"),
            row(480, "Current", "firstmate · AXI · henteplan"),
            section(524, "Contact"),
